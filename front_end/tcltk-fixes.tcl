##
##   $Id: tcltk-fixes.tcl 9 2005-01-23 05:27:26Z daly $
##

## Copyright (C) 1995 The New York Group Theory Cooperative
## See magnus/doc/COPYRIGHT for the full notice.

## Contents: Fixes for standard Tk package.
##
...
## Revision History:
##
## * 98/02/08 @dp Fixed and overrided standard Tk-4.6 and Tk-8.0 `bgerror'.
##
...
proc bgerror err {
    ...
    ##
    ## @dp Escape double-quotes into `err' to prevent an error in tk_dialog.
    ## 
    set dpErrMsg "Error: $err"
    regsub -all \" $dpErrMsg \\\" dpErrMsg
    
    global errorInfo
    set info $errorInfo
    set button [tk_dialog .bgerrorDialog "Error in Tcl Script" \
	    $dpErrMsg error 0 OK "Skip Messages" "Stack Trace"]

    ##
    ## @dp Here the changes are ended.
    ##
